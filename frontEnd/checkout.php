        ...
        <div class="checkout__container container grid">
          <div class="checkout__group">
            ...
            <form action="" class="form grid">
              ...
              <input type="text" placeholder="sosiéte" class="form__input">
          ...
          <div class="checkout__group">
            ...
            <table class="order__table">
              ...
              <tr>
                ...
                <td>
                  <h3 class="table__title">BOTTES D'INCENDIE MULTI-USAGE MONTAGE SOUDÉ</h3>
              ...
              <tr>
                ...
                <td>
                  <h3 class="table__title">CASQUE GALLET F1 XF</h3>
                  <p class="table__quantity">x 1</p>
                </td>

                <td><span class="table__price">$150.00</span></td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <h3 class="table__title">Véhicule Incendie Mousse</h3>
                  <p class="table__quantity">x 1</p>
                </td>

                <td><span class="table__price">$350.00</span></td>
              </tr>

              <tr>
                <td><span class="order__subtitle">SubTotal</span></td>
                <td colspan="2"><span class="table__price">---</span></td>
              </tr>
